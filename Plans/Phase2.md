...
POST /jobs {domain} should
store config_json.max_audit_urls = 10
store config_json.audit_runs_per_url = 3

GET /jobs/{id} shows caps + run_no + paused/overloaded state, max_audit_urls (10 by default), current run number
